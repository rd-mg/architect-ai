...
| Skill | Trigger | Path |
|-------|---------|------|
| Analyst Agent Profile |  | `internal/assets/skills/analyst/SKILL.md` |
| adaptive-reasoning | Single-entry classifier and cross-agent reasoning engine v3 | `internal/assets/skills/adaptive-reasoning/SKILL.md` |
