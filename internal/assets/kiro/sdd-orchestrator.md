...
Architect AI writes to the global steering file (`~/.kiro/steering/architect-ai.md`) — treat it as your active working context alongside your project steering files.
