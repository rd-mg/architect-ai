# Agent Teams Lite — General Orchestrator Core (Claude)
...
### On NON_SDD
→ Continue reading this document from "## General Orchestrator".
...
**Parallelize when:**
- Researching multiple topics → **MUST** launch N researchers
