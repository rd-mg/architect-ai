...
18.0 to 19.0. If your project only targets one version, consult
`patterns-18/` or `patterns-19/` instead.
...
- `patterns-18/` — Source version patterns (what you have now)
- `patterns-19/` — Target version patterns (what you're migrating to)
