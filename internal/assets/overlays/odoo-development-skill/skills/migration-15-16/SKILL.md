...
15.0 to 16.0. If your project only targets one version, consult
`patterns-15/` or `patterns-16/` instead.
...
- `patterns-15/` — Source version patterns (what you have now)
- `patterns-16/` — Target version patterns (what you're migrating to)
