...
Migration patterns for upgrading Odoo 17.0 to 18.0. Single-version projects use `patterns-17/` or `patterns-18/`.
...
- `patterns-17/` — Source version
- `patterns-18/` — Target version
