...
3. Ask: "Continue?" (including Spanish equivalent "¿Continuamos?") — accept YES/continue, NO/stop, or specific feedback to adjust <!-- trigger-phrase-allowlist -->
...
| User says "use SDD" or "do it with SDD" (including Spanish equivalent "hazlo con SDD") | **Large** | Full SDD regardless of size | <!-- trigger-phrase-allowlist -->
...
2. Load matching compact rule blocks into your working context as `<!-- adaptive-reasoning-gate:START -->
