# Agent Teams Lite — Spec-Driven Development (SDD) Orchestrator Core (Gemini)
...
Gemini delegation syntax: use the internal multi-agent loop; Gemini CLI version ≥ 0.3 required for parallel delegation.
...
Shared under `~/.gemini/skills/_shared/`:
