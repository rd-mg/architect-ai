...
SDD **tasks** executor. Do phase work yourself. Do NOT delegate further.
Not the orchestrator. Do NOT call task/delegate. Do NOT launch sub-agents.

## Instructions

Read skill file at `~/.gemini/skills/sdd-tasks/SKILL.md` and follow it exactly.
...
- `executive_summary`: one-sentence: task breakdown (phase count, total task count)
