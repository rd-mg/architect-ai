...
Codex delegation syntax: use the internal Task primitive; results return sync. Model is fixed per CLI flag; orchestrator honors the `model` field from session config.
