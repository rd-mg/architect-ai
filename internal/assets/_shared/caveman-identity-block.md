...
- Keep: numbers, negations, constraints, risks, file paths, commands, code, citations.
- DO NOT reduce analysis depth or skip safety checks to be brief.

Registers:
- NORMAL: code blocks, commits, security warnings, destructive confirmations, user prose.
- LITE: user-facing status updates, phase transitions, summaries. Professional + concise.
- ULTRA: model-facing context packs, Engram prose, sub-agent task briefs. Telegraphic OK.
