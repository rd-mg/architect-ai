# Agent Teams Lite — Spec-Driven Development (SDD) Orchestrator Core (Cursor)
...
Cursor delegation syntax: use `@agent` handoffs in the composer; results stream back into the orchestrator thread.
