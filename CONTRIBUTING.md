...
Thank you for your interest in contributing to **Architect AI** (`gga`) — a Go TUI installer for AI agent environments.
...
1. **Open an issue** using the appropriate template ([Bug Report](https://github.com/rd-mg/issues/new?template=bug_report.yml) or [Feature Request](https://github.com/rd-mg/issues/new?template=feature_request.yml))
...
```bash
git clone https://github.com/rd-mg/.git
cd architect-ai
go build -o gga .
```
...
Use [GitHub Discussions](https://github.com/rd-mg/discussions) — not issues — for questions, ideas, and general conversation.
